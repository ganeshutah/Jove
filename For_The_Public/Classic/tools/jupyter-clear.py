...
Copied from decabyte on GitHub [3] and modified by Michael Bentley.
...
References: 
    ...
    [3]: https://gist.github.com/decabyte/0ed87372774cf5d34d7e
"""
...
def main():    
    ...
    if nbs > 1:
       for old_ipynb in args.notebook:
        ...
        new_ipynb = args.output_filename
        if new_ipynb is None:
            new_ipynb = old_ipynb
        else:
            try:
                new_ipynb = os.path.splitext(new_ipynb)[0] + '.ipynb'
